          ...
          return (
            <motion.div
              ...
              style={{
                ...
                background: `linear-gradient(90deg, ${tc.bg}, var(--color-bg-glass))`,
                backdropFilter: 'blur(32px)',
                WebkitBackdropFilter: 'blur(32px)',
                border: `1px solid ${tc.border}`,
                boxShadow: alert.severity === 'CRITICAL'
                  ? `0 0 24px ${tc.bg}, inset 0 0 12px ${tc.bg}`
                  : 'inset 0 0 16px rgba(255,255,255,0.02), 0 8px 32px rgba(0,0,0,0.6)',
              }}
            >
              {/* Severity icon */}
              <div style={{
